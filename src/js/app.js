...
// TODO: 실제적인 인증관리는 API로 요청을 보낼 때 일어나야겠지
...
if ($.ajaxLoad) {
  ...
  $(document).on('click', '.nav a[href!="#"]', function(e) {
    ...
    let thisNav = $(this).parent().parent();
...
function init(url) {
  ...
  $('[rel="popover"],[data-rel="popover"],[data-toggle="popover"]').popover();
    ...
    // Bootstrap Datepicker Intialize
    ...
    // https://stackoverflow.com/questions/26639346/prevent-bootstrap-dropdown-from-closing-on-clicks
